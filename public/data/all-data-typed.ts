...
export function enrichClass(cls: Class) {
  let enrichedClass = { ...cls };
  enrichedClass.course = data.courses.find((c) => c.id === enrichedClass.courseId);
  enrichedClass.instructor = data.instructors.find((c) => c.id === enrichedClass.instructorId);
  enrichedClass.room = data.rooms.find((c) => c.id === enrichedClass.roomId);
  return enrichedClass;
}

export function enrichCourse(course: Course) {
  let enrichedCourse = { ...course };
  enrichedCourse.department = data.departments.find((d) => d.id === enrichedCourse.departmentId);
